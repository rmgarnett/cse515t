...
{\large \textbf{CSE 5015: Bayesian Methods in Machine Learning (Fall 2026)}} \\[1ex]

\begin{tabular}{rl}
               Instructor & Professor Roman Garnett                                 \\
                \acro{TA} & Andrew Tipping                                          \\
            Time/Location & Monday/Wednesday 10--11:20pm, Seigle 103                \\
   Office Hours (Garnett) & by appointment, always available on Slack               \\
 Office Hours (\acro{TA}) & \acro{TBA}                                              \\
               \acro{URL} & \url{www.cse.wustl.edu/~garnett/cse515t/fall_2026/}     \\
                   GitHub & \url{github.com/rmgarnett/cse515t}                      \\
     Slack & \url{bit.ly/4gIxkJn}
\end{tabular}
...
Please note that this is not an introduction to machine learning; the \acro{CSE
  4107/5107} and \acro{ESE 4017} courses fill that role.  I will assume prior
...
There will be an in-class quiz on (approximately) the following dates:
\begin{itemize}
  \item August 26 (``quiz 0'' -- will assess prerequisite knowledge)
  \item September 2
  \item September 9
  \item September 23
  \item October 7
...
If you would like to use an AI agent while completing your assignments, that's
fine with me. Just make sure you trust its output!
