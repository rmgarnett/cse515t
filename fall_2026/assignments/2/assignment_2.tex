...
{\large \textbf{CSE 5105 (Fall 2026) Assignment 2}} \\
Due Wednesday, 7 October 2025 \\
...
\item
  ...
  Suppose we flip a coin $n = 10$ times and observe $x = 9$ ``heads.''
...
\item
  ...
  observe $x = 600$ successes. Call the unknown bias of the coin
  $\theta \in (0, 1)$.
