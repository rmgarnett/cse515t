...
\begin{tabular}{rl}
            ...
            Time/Location & Tuesday/Thursday 2--4:30pm, Whitaker 218                \\
   Office Hours (Garnett) & Tuesday/Thursday 4:30--5:30pm, Jolley 504               \\
  Office Hours (Malkomes) & Friday 3--4pm, Jolley 504               \\
...
\item \emph{Statistical Decision Theory and Bayesian Analysis} by
  ...
  introduction to Bayesian methods.  Very clear.  Provides convincing
  philosophical arguments for the Bayesian viewpoint.
...
Assignments will be due during class on the dates specified on the
course homepage.  I will allow you to turn in your assignment up to
one class late with no penalty.
